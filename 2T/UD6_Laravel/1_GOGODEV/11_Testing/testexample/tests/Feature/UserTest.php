...
class UserTest extends TestCase
{
    ...
    public function test_set_database_config(): void
    {
        ...
        if($response->assertStatus(200)){
            ...
            Log::info("La prueba test_set_database_config ha pasado correctamente");
        }
    ...
    public function test_get_users_list(): void
    {
        ...
        $response->assertJsonStructure([
            ...
            //En este caso, sabemos que debe devolver un usuario con nombre Alejandro
    ...
    public function test_get_user_detail(): void
    {
        ...
        //Aquí comprobamos que el usuario con ID 1 se llame Alejandro, no necesitamos contar el número de elementos
        $response->assertJsonFragment([
            'id' => $userId,
            'name' => 'Alejandro', // Assuming the user with ID 1 is named Alejandro
        ]);
    }
